							...
							<div id="css" class="section-block">
								<div class="code-block">
									<h6>CSS Code Example</h6>
                                        <pre class=" language-css"><code class=" language-css"><span class="token comment" spellcheck="true">/* ======= Base Styling ======= */</span>
...
*/</span>
<span class="token atrule"><span class="token rule">@import</span> <span class="token string">"mixins.less"</span><span class="token punctuation">;</span></span>
<span class="token atrule"><span class="token rule">@import</span> <span class="token string">"theme-default.less"</span><span class="token punctuation">;</span></span>
...
<span class="token atrule"><span class="token rule">@import</span> <span class="token string">"doc.less"</span><span class="token punctuation">;</span></span>
<span class="token atrule"><span class="token rule">@import</span> <span class="token string">"landing.less"</span><span class="token punctuation">;</span></span>
<span class="token atrule"><span class="token rule">@import</span> <span class="token string">"responsive.less"</span><span class="token punctuation">;</span></span></code></pre>
								</div><!--//code-block-->
							</div><!--//section-block-->
							<div id="sass" class="section-block">
								<div class="code-block">
									<h6>Sass Code Example</h6>
                                        <pre class=" language-sass"><code class=" language-sass">
<span class="token selector">#main {</span>
<span class="token variable-line">    <span class="token variable">$width</span><span class="token punctuation">:</span> 5em; </span>
<span class="token property-line">    <span class="token property">width</span><span class="token punctuation">:</span> <span class="token variable">$width</span>; </span>
...
<span class="token operator">&lt;</span><span class="token operator">/</span>script<span class="token operator">&gt;</span></code>
                                        </pre>
								</div><!--//code-block-->
							</div><!--//section-block-->
...
<span class="token operator">&gt;&gt;</span><span class="token operator">&gt;</span> x <span class="token operator">=</span> int<span class="token punctuation">(</span>input<span class="token punctuation">(</span>"
Please enter an integer<span class="token punctuation">:</span> "<span class="token punctuation">)</span><span class="token punctuation">)</span> Please enter an integer<span class="token punctuation">:</span> <span class="token number">42</span>
...
<span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span> More</code></pre>
								</div><!--//code-block-->
							</div><!--//section-block-->
...
<span class="token keyword">echo</span> "<span class="token markup"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>br</span><span class="token punctuation">&gt;</span></span></span>"<span class="token punctuation">;</span> 
...
out = out + "<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>li</span><span class="token punctuation">&gt;</span></span>" + options.fn(items[i]) + "<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>li</span><span class="token punctuation">&gt;</span></span>";
}
...
return out + "<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>ul</span><span class="token punctuation">&gt;</span></span>";
								...
								<div class="code-block">
									...
									<pre class=" language-git"><code class="language-git"><span class="token command">$ git add Documentation.txt</span></code></pre>
								</div><!--//code-block-->
							</div><!--//section-block-->
						</section><!--//doc-section-->
				...
				<div class="doc-sidebar hidden-xs">
					<nav id="doc-nav">
						<ul id="doc-menu" class="nav doc-menu affix" data-spy="affix">
							<li class=""><a class="scrollto" href="#download-section">Download</a></li>
							<li class="">
								<a class="scrollto" href="#installation-section">Installation</a>
								<ul class="nav doc-sub-menu">
									<li class=""><a class="scrollto" href="#step1">Step One</a></li>
									<li class=""><a class="scrollto" href="#step2">Step Two</a></li>
									<li class=""><a class="scrollto" href="#step3">Step Three</a></li>
								</ul><!--//nav-->
							</li>
							<li class="active">
								<a class="scrollto" href="#code-section">Code</a>
								<ul class="nav doc-sub-menu">
									<li class=""><a class="scrollto" href="#html">HTML</a></li>
									<li class=""><a class="scrollto" href="#css">CSS</a></li>
									<li class=""><a class="scrollto" href="#less">LESS</a></li>
									<li class=""><a class="scrollto" href="#sass">Sass</a></li>
									<li class=""><a class="scrollto" href="#javascript">JavaScript</a></li>
									<li class=""><a class="scrollto" href="#python">Python</a></li>
									<li class="active"><a class="scrollto" href="#php">PHP</a></li>
									<li class=""><a class="scrollto" href="#handlebars">Handlebars</a></li>
								</ul><!--//nav-->
							</li>
							<li class=""><a class="scrollto" href="#callouts-section">Callouts</a></li>
							<li class=""><a class="scrollto" href="#tables-section">Tables</a></li>
							<li class=""><a class="scrollto" href="#buttons-section">Buttons</a></li>
							<li class=""><a class="scrollto" href="#video-section">Video</a></li>
